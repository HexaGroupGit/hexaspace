...
export const SPACES: Space[] = [
  ...
  },
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        capacity: 'Up to 6 guests',
        price: '$40 +GST / hour',
        image: '/photos/room-sun.jpg',
        features: [
          'A bright Level 2 team room seating up to six',
          'Presentation screen & video-conferencing ready',
          'Floor-to-ceiling windows & natural light',
          'Curated catering on request',
          'Unlimited tea, great coffee & filtered water',
        ],
      },
      {
        ...
        capacity: 'Up to 6 guests',
        price: '$40 +GST / hour',
        image: '/photos/room-moon.jpg',
        features: [
          'A calm Level 2 team room for up to six',
          'Presentation screen & video-conferencing ready',
          'Floor-to-ceiling windows & natural light',
          'Curated catering on request',
          'Unlimited tea, great coffee & filtered water',
  ...
  },
  {
    ...
    intro:
      'A broadcast-ready studio on Level 2 — acoustically treated, beautifully lit and permanently rigged, so there is nothing to set up. Two broadcast microphones face each other across the table, wired into a mixing console with live processing, alongside a teleprompter and multi-camera video. Book it by the hour, sit down and record; hand the files to our in-house team and they come back edited, mastered and ready to publish. It’s also where we record the Hexa Space podcast.',
    image: '/photos/podcast-studio.jpg',
    inclusions: [
      'Acoustically treated, soundproofed room',
      'Two broadcast microphones on boom arms',
      'Mixing console with live processing',
      'Multi-camera video recording',
      'Teleprompter & on-camera monitor',
      'Studio lighting, softboxes & backdrop',
      'Everything pre-rigged and levelled',
      'In-house editing & post-production',
      'Publishing & distribution support',
      'Member rates on every booking',
    ],
    configurations: [
      { layout: 'Solo', capacity: '1 host · audio or video' },
      { layout: 'Interview', capacity: '1 host + 1 guest' },
      { layout: 'Video podcast', capacity: 'Multi-camera + teleprompter' },
      { layout: 'Remote guest', capacity: 'Bring a third in by link' },
    ],
    gallery: [
      '/photos/podcast-room.jpg',
      '/photos/podcast-mic.jpg',
      '/photos/podcast-console.jpg',
      '/photos/podcast-camera.jpg',
    ],
